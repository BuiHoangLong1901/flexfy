...
import { S as StarIcon, I as ImageAnimation, a as Image, C as CollapseAni, g as getColors, b as getSizes, c as getMenu, d as getListProducts, e as getCategoryBySlug, $ as $$Layout } from './_...any_.astro.4e74df7c.mjs';
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<div id="productDetail">
    ${renderComponent($$result2, "ProductDetail", null, { "slug": slug, "client:only": true, "client:component-hydration": "only", "client:component-path": "D:/src/src/components/product-detail", "client:component-export": "ProductDetail" })}
  </div>
` })}`;

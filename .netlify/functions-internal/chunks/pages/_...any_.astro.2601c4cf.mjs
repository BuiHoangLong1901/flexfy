import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, s as spreadAttributes, u as unescapeHTML, d as renderComponent, m as maybeRenderHead, e as renderSlot, f as renderHead } from '../astro.daf0d03a.mjs';
...
const Image = (props) => {
  ...
  return /* @__PURE__ */ jsx("img", { ...other, "aria-label": ariaLabel });
};
const ImageAnimation = (props) => {
  const { ariaLabel, loading = "lazy", ...other } = props;
  return /* @__PURE__ */ jsx(motion.img, { ...other, "aria-label": ariaLabel, loading });
};
...
const StarIcon = (props) => {
  const { width = 20, height = 20, fill, stroke } = props;
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("clipPath", { id: "a", children: /* @__PURE__ */ jsx("path", { fill: "#fff", d: "M.556.95h7.09v7.533H.556z" }) }) })
      ]
    }
  );
};
const Logo = () => {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxs("g", { id: "Layer_1", clipPath: "url(#clip0_151_3976)", children: [
          /* @__PURE__ */ jsx(
            "path",
            {
              id: "Vector",
          ...
          /* @__PURE__ */ jsxs("g", { id: "Group", children: [
            /* @__PURE__ */ jsx(
              "path",
              {
                id: "Vector_3",
        ...
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("clipPath", { id: "clip0_151_3976", children: /* @__PURE__ */ jsx(
          "rect",
          {
            width: "64",
            height: "25",
...
const SelectBox = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        label && /* @__PURE__ */ jsx("div", { className: "select-label", children: /* @__PURE__ */ jsx("span", { children: label }) }),
        /* @__PURE__ */ jsx(
          "input",
          {
        ...
        showDropDown && /* @__PURE__ */ jsx(
          motion.ul,
          {
            ...
            animate: "visible",
            exit: "hidden",
            children: items.length ? items.map((item, idx) => /* @__PURE__ */ jsx(
              "li",
              {
                onClick: () => handleChangeSelect(item),
                children: /* @__PURE__ */ jsx("div", { className: "select-option", children: item.label })
              },
              item.value + idx
            )) : /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("div", { className: "select-option", children: "no options" }) })
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "select-icon-close", children: IconEnd ?? /* @__PURE__ */ jsx(
          Image,
          {
...
}, "D:/src/node_modules/astro-seo/src/components/OpenGraphArticleTags.astro", void 0);
...
}, "D:/src/node_modules/astro-seo/src/components/OpenGraphBasicTags.astro", void 0);
...
${height ? renderTemplate`<meta property="og:image:height"${addAttribute(height, "content")}>` : null}
${alt ? renderTemplate`<meta property="og:image:alt"${addAttribute(alt, "content")}>` : null}`;
}, "D:/src/node_modules/astro-seo/src/components/OpenGraphImageTags.astro", void 0);
...
}, "D:/src/node_modules/astro-seo/src/components/OpenGraphOptionalTags.astro", void 0);
...
}, "D:/src/node_modules/astro-seo/src/components/ExtendedTags.astro", void 0);
...
}, "D:/src/node_modules/astro-seo/src/components/TwitterTags.astro", void 0);
...
}, "D:/src/node_modules/astro-seo/src/components/LanguageAlternatesTags.astro", void 0);
...
}, "D:/src/node_modules/astro-seo/src/SEO.astro", void 0);

const Collapse = (props) => {
  const { items, labels, className } = props;
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  return /* @__PURE__ */ jsx("section", { id: "collapse", className, children: /* @__PURE__ */ jsxs("div", { className: "collapse-container", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { children: labels }),
          /* @__PURE__ */ jsx("span", { id: "icon-toggle", children: isMenuOpen ? "–" : "+" })
        ]
      }
    ),
    /* @__PURE__ */ jsx("ul", { className: `collapse-menu ${isMenuOpen ? "show" : ""}`, children: items?.map((item, idx) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
      "a",
      {
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: RenderHeader ? RenderHeader : /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("span", { className: "header-left", children: btnText }),
              headerIcon && /* @__PURE__ */ jsx("span", { className: "header-right", children: open ? "–" : "+" })
            ] })
          }
        ),
        /* @__PURE__ */ jsx(AnimatePresence, { initial: true, children: open && /* @__PURE__ */ jsx(
          motion.div,
          {
            initial: "collapsed",
            className: "content",
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="information">
    <div class="logo-container">
      <div class="logo-footer">
        ${renderComponent($$result, "Image", Image, { "alt": "logo-1", "ariaLabel": "logo-1", "className": "item-6", "src": "/assets/icons/logo-1.svg" })}
      ...
      <div class="div-footersignup">
        ...
        <p class="text-form">
          <span class="text-wrapper">*By signing up, you agree to receive marketing emails from FLEXFY.
    ...
    <div class="list-infor">
      <div class="list-footerinfo">
        ${footer?.map((l) => renderTemplate`${renderComponent($$result, "Collapse", Collapse, { "client:load": true, "labels": l.name, "items": l.menu.map((m) => ({ label: m.name, code: m.slug })), "client:component-hydration": "load", "client:component-path": "D:/src/src/components/Collapse", "client:component-export": "Collapse" })}`)}
      </div>
  ...
  <div class="contact">
    ...
    <div class="curency-info">
      ${renderComponent($$result, "SelectBox", SelectBox, { "defaultValue": currency[0].value, "items": currency, "className": "select-currency form-input", "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/src/src/components/SelectBox", "client:component-export": "SelectBox" })}
    </div>
  </div>
</footer>`;
}, "D:/src/src/layouts/Footer.astro", void 0);

function Menu({ slug, data }) {
  return /* @__PURE__ */ jsx("div", { className: "menu", id: "nav-menu", children: /* @__PURE__ */ jsxs("div", { className: "list", children: [
    /* @__PURE__ */ jsxs("div", { className: "item-link", children: [
      /* @__PURE__ */ jsx("div", { className: "label-event", children: /* @__PURE__ */ jsxs("span", { className: "text-wrapper text-event", children: [
        "SUMMER VIBE COLLECTION",
        /* @__PURE__ */ jsx("span", { className: "text-wrapper text-event-2", children: "2023" })
      ] }) }),
      /* @__PURE__ */ jsx("span", { className: "toggle-menu close-icon", children: /* @__PURE__ */ jsx(
        Image,
        {
    ...
    data && data.map((item, index) => /* @__PURE__ */ jsx(
      "a",
      {
        href: "/collections/" + item.slug,
        className: `bras-wrapper ${item.slug === slug && "active"}`,
        children: /* @__PURE__ */ jsx("span", { className: "menu-title", children: item.name })
      },
      "menu_" + item + "_" + index
    ))
  ] }) });
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header id="header-layout" class="header-desktop">
  <div class="div-shopify-section">
    <div class="drawler"${addAttribute({ display: "none" }, "style")}></div>
    <div class="banner">
      ...
      <a href="/" class="banner-logo" aria-label="logo"> ${renderComponent($$result, "Logo", Logo, {})}</a>
      <div class="div banner-option">
        <div class="search-wrapper">
          <input type="text" name="search" placeholder="search">
          ${renderComponent($$result, "Image", Image, { "id": "search-icon", "alt": "flexfy-search-icon", "ariaLabel": "flexfy-search-icon", "src": "/assets/icons/search-icon.svg", "width": 20, "height": 26 })}
        </div>
        <div class="div menu-right">
          <div class="item cart-toggle">
            <div class="overlap-group">
              ${renderComponent($$result, "Image", Image, { "id": "cart-icon", "alt": "flexfy-cart-icon", "ariaLabel": "flexfy-cart-icon", "src": "/assets/icons/cart.svg", "width": 20, "height": 26 })}
              ${renderComponent($$result, "CartCount", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "D:/src/src/icon", "client:component-export": "CartCount" })}
            </div>
          </div>
          <a href="/login">
            ${renderComponent($$result, "Image", Image, { "id": "user-icon", "alt": "flexfy-user-icon", "ariaLabel": "flexfy-user-icon", "className": "hover-pointer", "src": "/assets/icons/user.svg", "width": 20, "height": 26 })}
          </a>
        </div>
        ${renderComponent($$result, "Image", Image, { "alt": "Menu", "ariaLabel": "Menu", "src": "/assets/icons/menu.svg", "className": "hover-pointer toggle-menu menu-icon", "width": 20, "height": 26 })}
      </div>
    </div>
    <div class="header-menu">
      ${renderComponent($$result, "Menu", Menu, { "data": menu, "slug": slug })}
    </div>
  </div>
</header>`;
}, "D:/src/src/layouts/Header.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en">\n  <head>\n    <meta charset="UTF-8">\n    ', "\n    ", '\n    <meta name="viewport" content="width=device-width">\n    <link rel="icon" type="image/svg+xml" href="/favicon.svg">\n    <title>', "</title>\n  ", "</head>\n\n  <body>\n    ", "\n    <main>\n      ", "\n    </main>\n    ", "\n    ", '\n    <script type="module">\n      const header = document.getElementById("header-layout");\n      const drawler = document.querySelector(".drawler");\n      function toggleMenu() {\n        const elem = document.querySelector("#nav-menu");\n        elem.classList.remove("active");\n        drawler.style.display = "none";\n      }\n      window.addEventListener("resize", () => {\n        toggleMenu();\n      });\n      document.addEventListener("scroll", () => {\n        if (window.screen.width < 768) return;\n        if (document.documentElement.scrollTop > header.offsetHeight) {\n          header?.classList.add("header-mobile");\n        } else {\n          header?.classList.remove("header-mobile");\n        }\n      });\n    <\/script>\n  </body>\n</html>'])), noindex && renderTemplate`<meta name="robots" content="noindex">`, !noindex && seo && renderTemplate`${renderComponent($$result, "SEO", $$SEO, { ...seo })}`, title, renderHead(), renderComponent($$result, "Header", $$Header, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "CartModal", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "D:/src/src/components/CartModal", "client:component-export": "CartModal" }));
}, "D:/src/src/layouts/Layout.astro", void 0);

const NotFound = () => /* @__PURE__ */ jsx(
  "main",
  {
    ...
    children: /* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsxs("div", { className: "content", children: [
      /* @__PURE__ */ jsx("h1", { className: "error", children: "404" }),
      /* @__PURE__ */ jsx("h1", { className: "title", children: "Page not found!" }),
      /* @__PURE__ */ jsx("span", { className: "go-home", children: /* @__PURE__ */ jsx("a", { "aria-label": "Return to home page", href: "/", children: "Go home?" }) })
    ] }) })
  }
);
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "404 - Page not found" }, { "default": ($$result2) => renderTemplate`
  ${renderComponent($$result2, "NotFound", NotFound, {})}
` })}`;
}, "D:/src/src/pages/[...any].astro", void 0);
...
export { $$Layout as $, CollapseAni as C, ImageAnimation as I, StarIcon as S, ____any_ as _, Image as a, getSizes as b, getMenu as c, getListProducts as d, getCategoryBySlug as e, getBanners as f, getColors as g, getProductsByHome as h, getPromotion as i, getCommunities as j, getAdvertises as k, SelectBox as l, getAllCountries as m };

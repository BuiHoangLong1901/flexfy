        ...
        <div class="div menu-right">
          <div class="item cart-toggle">
            <div class="overlap-group">
              ...
              ${renderComponent($$result, "CartCount", null, { "client:only": true, "client:component-hydration": "only", "client:component-path": "D:/src/src/icon", "client:component-export": "CartCount" })}
            </div>
          </div>
          <a href="/login">

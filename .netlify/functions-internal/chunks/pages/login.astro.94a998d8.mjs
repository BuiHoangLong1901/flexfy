...
import { l as SelectBox, $ as $$Layout } from './_...any_.astro.2601c4cf.mjs';
import { jsx, jsxs } from 'react/jsx-runtime';
import { forwardRef, useState, useRef, useImperativeHandle, Fragment } from 'react';
import { motion } from 'framer-motion';
import { M as MATCH_EMAIL } from './_slug_.astro.632ec7f7.mjs';
...
const Form = (props, ref) => {
  ...
  const formValues = () => {
    if (!formRef.current)
      return;
    const formValues2 = Object.fromEntries(
  ...
  return /* @__PURE__ */ jsx(
    "form",
    {
      ...
      children: inputs.map((input, index) => {
        return input.type === "select" /* SELECT */ && input.data ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(
            SelectBox,
            {
              items: input.data,
              ...
              onChange: (item) => setValues && setValues({ [input.name]: item })
            }
          ),
          inputErrors[input.name] && /* @__PURE__ */ jsx(
            motion.p,
            {
        ...
        ] }, `FORM_ITEM_${input.name}_${index}`) : /* @__PURE__ */ jsxs(
          "div",
          {
...
const LoginForm = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "form-login-wrapper", children: [
    /* @__PURE__ */ jsx("h1", { children: "Already a Member? Welcome Back!" }),
    /* @__PURE__ */ jsx("p", { className: "form-description", children: "Access your order history, check your points balance, and claim your FLEXFY Rewards." }),
    /* @__PURE__ */ jsx(FormProvider, { inputs, ref: formRef, className: "login-form" }),
    /* @__PURE__ */ jsx("button", { className: "form-button", onClick: onSubmit, children: "sign in" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "form-text", children: /* @__PURE__ */ jsx("a", { href: "#", children: "Forgot your password?" }) })
  ] });
};

const CustomerForm = () => {
  return /* @__PURE__ */ jsxs("div", { className: "customer-wrapper form-login-wrapper", children: [
    /* @__PURE__ */ jsx("h1", { children: "New? Sign Up for Rewards!" }),
    /* @__PURE__ */ jsx("p", { className: "form-description", children: "Life’s sweeter as a member! Create an account to join our super cool Rewards Program – that’s an instant ₱50 OFF. Rack up points with every purchase - the more you shop, the more you earn!" }),
    /* @__PURE__ */ jsx("button", { className: "form-button", children: /* @__PURE__ */ jsx("a", { href: "/register", children: "create account" }) }),
    /* @__PURE__ */ jsx("div", { className: "form-image-wrap" })
  ] });
};
...
const $$Login = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Login;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Flexfy - Login" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<div class="banner-login-screen"></div>
  <div id="form-layout">
    ${renderComponent($$result2, "LoginForm", LoginForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/src/src/components/login/LoginForm", "client:component-export": "LoginForm" })}
    ${renderComponent($$result2, "CustomerForm", CustomerForm, {})}
  </div>
` })}`;
